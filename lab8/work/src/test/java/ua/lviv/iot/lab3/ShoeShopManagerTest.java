...
class ShoeShopManagerTest {
    ...
    void setUp() {
        ...
        shoe1 = new Sneakers(1,"ZTX90", Type.SPORT, Brand.ADIDAS, Size.INT_40, "White with black dots", 1220, "syntetic leather");
        shoe2 = new SnowBoots(2,"Wolf", Type.WINTER, Brand.TIMBERLAND, Size.INT_40, "Grey", 4500, "Leather");
        shoe3 = new Sneakers(3,"RONALDO", Type.SPORT, Brand.ADIDAS, Size.INT_40, "Black and gold stripes", 1560, "syntetic leather");
        shoe4 = new FlipFlops(4,"Sun", Type.SUMMER, Brand.PEAK, Size.INT_40, "Yellow", 400, "Rubber");
        shoe5 = new Loafers(5, "Mark I", Type.SUMMER, Brand.GUCCI, Size.INT_42, "Black", 4500, "Leather");
